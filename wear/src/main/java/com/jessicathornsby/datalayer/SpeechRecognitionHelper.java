...
public class SpeechRecognitionHelper {
     ...
     * @param ownerActivity  - Activity, that initiated a request
     */
    private static void startRecognitionActivity(Activity ownerActivity) {
        ...
        intent.putExtra(RecognizerIntent.EXTRA_PROMPT, "Está usted bien?");    // user hint
        ...
        intent.putExtra(RecognizerIntent.EXTRA_MAX_RESULTS, 5);    // quantity of results we want to receive
